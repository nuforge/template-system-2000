<div id="member_login_popup" class="default_popup popUpDiv" style="display:none; width: 500px;">
    <div class="round_dark">
        ...
        <h2><a href="{pageValue(#mainurl#)}" title="{pageValue(#sitename#)}">{pageValue(#sitename#)}</a> Account Login</h2>
        <form action="/login.html" method="post" name="login_form" id="login_form" rel="nofollow">
            <table class="hidden">
                ...
                <tr>
                    <th colspan="2">
                        <div style="float: right">
                            <a class="csspopup_approve_button" onClick="document.login_form.submit();">Log In To {pageValue(#sitename#)}</a>
                        </div>
